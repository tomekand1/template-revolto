...
export const state = () => ({
    ...
    settings: {
        ...
        about: {
            title: "Finansowanie",
            description: "  finanse to "
        },

        dotacja: {
            title: "Dotacja",
            description1: "Datacje to...",
            description2: "dotacje to ",
            boldSign: "bold "
        },
        kredyt: {
            title: "kredyt/leasing",
            description1: "kredyt to...",
            description2: "kredyt to ",
            description3: "opis2",
            description4: "opiss3"
        },
        gotowka: {
            title: "Gotowka",
            description1: "Gotowka to...",
            description2: "Gotowka to ",
            boldSign: "bold"
        },
        offer: {
        ...
        kontakt: {
            ...
            phone: "435234523523523",
            mail: "email@op.pl",
            godzinyOtwarcia: "pon-piatek: 8:00am - 8:00pm",
            twitter: "tweeter",
